  ...
  ({ className, ...props }, ref) => {
    return (
      <div
        ref={ref}
        data-sidebar="footer"
        className={cn("flex flex-col gap-2 p-2 shrink-0 bg-sidebar", className)}
        {...props}
      />
    );
  },
  ...
  ({ className, ...props }, ref) => {
    return (
      <div
        ...
        className={cn(
          "flex min-h-0 flex-1 flex-col gap-2 overflow-y-auto overflow-x-hidden bg-sidebar group-data-[collapsible=icon]:overflow-hidden",
          className,
        )}
        {...props}
      />
